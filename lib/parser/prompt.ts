...
- "deadline": якщо справа має кінцевий термін ("до пʼятниці", "оплатити до 8-го", "до понеділка") — рядок "YYYY-MM-DD". Відносні терміни переводь відносно сьогоднішньої дати. Якщо терміну нема — null.

Жорсткі правила:
- НЕ оцінюй тривалість. Поля тривалості не існує.
- НЕ вигадуй справ, яких нема в тексті. НЕ об'єднуй різні справи в одну.
- Розрізняй fixed_time (конкретний час сьогодні) і deadline (кінцева дата). Одна справа може мати щось одне, обидва, або нічого.
